...
\small{
    I recently completed my Computer Engineering undergraduate degree at Colorado State University.\\
...
\item \textbf{Programming Languages:}
  ...
  \item \makebox[3.5cm][l]{Object-Oriented} Arduino INO, \textbf{\Cpp}, Java, JavaScript, Python, \textbf{Rust}
  \item \makebox[3.5cm][l]{Functional} Lisp, Elisp, \LaTeX, Scala
  \end{itemize}
