...
\small{I am a rising senior year undergraduate Computer Engineering student at Colorado State University pursuing a Bachelor's degree.\\
...
\item \textbf{Libraries and Frameworks:} 
  ...
  \item \makebox[3.5cm][l]{Web Based} Rocket.rs, ReactJS, VueJS, NodeJS, ExpressJS, jQuery
  \end{itemize}
\end{itemize}
% -------------------------------------
% WORK EXPERIENCE
...
\begin{itemize}
\item{\cventry{May 2021 -- Present}{Hewlett Packard Enterprise -- NonStop Low-Level Team}
