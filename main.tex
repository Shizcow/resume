...
\item{\cventry{Graduating May 2022}{Bachelor of Science in Computer Engineering, Minor in Mathematics, Minor in Computer Science}{Colorado State University}{Fort Collins, CO}{}{
    ...
    \item \textbf{Relevant Coursework:}
      ...
      Signals and Systems
    \item \textbf{ECE Outreach:} Exciting Middle and High School students about Electrical and Computer Engineering by teaching\\
      seminars on programming, leading in-class workshops on robotics,
      and building eye-catching electronics demos\\
      \textit{Digital Team Lead}: Organizing events, overseeing projects, collaborating with other Outreach teams, and networking across CSU
    \end{itemize}
}}
\end{itemize}
% -------------------------------------
