...
\begin{center}
  \small{
    \begin{tabular}{l}
      I am a first-year PhD student beginning my research in writing compilers for novel architectures. \\
...
\section{Education}
\begin{itemize}
\item{\cventry{Aug 2023 \textendash\xspace Present}{Doctorate of Philosophy in Computer Science}{Georgia Institute of Technology}{Atlanta, GA}{}{
    \begin{itemize}
...
\begin{itemize}
\item{\cventry{Jun 2022 \textendash\xspace Aug 2023}{Microsoft \textemdash\xspace DevDiv PLINCO Team}
...
\item{\cventry{May 2021 \textendash\xspace Aug 2021}{Hewlett Packard Enterprise \textemdash\xspace NonStop Low-Level Team}
...
\item{\cventry{May 2020 \textendash\xspace Aug 2020}{Hewlett Packard Enterprise \textemdash\xspace NonStop Manageability Team}
...
\begin{itemize}
\item{\cventry{\httplink[CRNCH Lab]{crnch.gatech.edu/}}{Georgia Institute of Technology \textemdash\xspace Under \httplink[Tom Conte]{ece.gatech.edu/directory/tom-conte}}
  ...
  \iftoggle{yashwant}{
  \item{\cventry{Department of Computer Science}{Colorado State University \textemdash\xspace Under Dr. Yashwant Malaiya}
  ...
  \iftoggle{seniord}{
  \item{\cventry{Department of Electrical and Computer Engineering}{Colorado State University \textemdash\xspace Under Prof. Olivera Notaros}
