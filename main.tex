...
\small{I am a senior year undergraduate student studying Computer Engineering at Colorado State University.\\
  I have a passion for programming and electronics, with interests in low-level, embedded, and kernel-space programming.}
...
\item{\cventry{Graduating May 2022}{Bachelor of Science in Computer Engineering, Minor in Mathematics, Minor in Computer Science}{Colorado State University}{Fort Collins, CO}{}{
    ...
    \item \textbf{Senior Design:}
      \begin{itemize}
      \item Designing and implementing an embedded systems framweork for enterprise-grade
        quadrapedal robotics applications
...
\item \textbf{Programming Languages:}
  \begin{itemize}
    \item \makebox[3.5cm][l]{Procedural} ARM Assembly, Bash, \textbf{C}, Fish, Matlab, MIPS, Spice, Verilog
    \item \makebox[3.5cm][l]{Object-Oriented} Arduino INO, \textbf{\Cpp}, Java, \textbf{JavaScript}, Python, \textbf{Rust}, VBS
...
\item \textbf{Libraries and Frameworks:} 
  ...
  \item \makebox[3.5cm][l]{Computational} GMP, OpenMP, OpenCL, OpenGL, GLSL, Rink.rs, Sage
...
\item{\cventry{May 2021 -- Aug 2021}{Hewlett Packard Enterprise -- NonStop Low-Level Team}
  {Platform Engineering Intern}{Fort Collins, CO}{}{
    ...
    \item Proved feasibility of an implemtation method that would drasticaly reduce startup cost for new customers
    \item Worked in \Cpp with InfiniBand and NSK to invisibly apply modifications to existing benchmarks and applications
    \end{itemize}
}}
...
\item{\cventry{\protect\raisebox{-0.25mm}{\includegraphics[scale=0.205,decodearray={0 0 0 0 0 0}]{rust_logo.png}}\xspace\httplink[docs.rs/hotpatch]{docs.rs/hotpatch/0.3.0/hotpatch/}}{\protect\faGithub\xspace\httplink[Shizcow/hotpatch]{www.github.com/Shizcow/hotpatch}}{hotpatch}{v0.3.0 Released Feb 2021}{}{
    ...
    \item Guarentees memory saftey, thread saftey, deadlock protection, type correctness, and namespace parity
    \end{itemize}
}}
\item{\cventry{\protect\raisebox{-0.25mm}{\includegraphics[scale=0.205,decodearray={0 0 0 0 0 0}]{arch_logo.png}}\xspace\httplink[arch::aur::dmenu-rs]{aur.archlinux.org/packages/dmenu-rs}}{\protect\faGithub\xspace\httplink[Shizcow/dmenu-rs]{www.github.com/Shizcow/dmenu-rs}}{dmenu-rs}{v5.5.1 Released Dec 2020}{}{
    ...
    \item Maintains perfect backwards compatibility, garnering thousands of users and 100\+ stars on GitHub
    \end{itemize}
}}
\end{itemize}
